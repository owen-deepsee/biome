...
use rome_control_flow::{builder::FIRST_BLOCK_ID, ExceptionHandlerKind, InstructionKind};
...
impl Rule for UseGetterReturn {
    ...
    fn run(ctx: &RuleContext<Self>) -> Self::Signals {
        ...
        let mut block_stack = vec![FIRST_BLOCK_ID];
        let mut visited_blocks = RoaringBitmap::new();
        visited_blocks.insert(FIRST_BLOCK_ID.index());
